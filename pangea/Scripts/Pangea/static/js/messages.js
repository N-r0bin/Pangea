// establish connection between frontend & backend async
...
socket.onopen = async function(e){
    ...
    send_message_form.on('submit', function(e){
        ...
        let data = {
            ...
            'send_to': send_to,
            'thread_id': thread_id
        }  // sending these information to backend, will use it & store it somewhere 
        data = JSON.stringify(data)
        socket.send(data) // send function directly send information from frontend to consuner
        $(this)[0].reset()
    })
}

// all messages being triggered to the backend
